...
def define():
    ...
    return render_template('textarea-div.html.j2', definition=definition)
...
def reset():
    ...
    return render_template('input-fields-div.html.j2', definition=definition, default_word=DEFAULT_WORD,
