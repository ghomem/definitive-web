...
def get_autogenerated_definition(text):
    ...
    prompt = f"Please provide a fictional and funny definition of {text}. Do not use more than 160 characters."
    ...
    try:
        ...
        # crop to maximum length, as it sometimes ignores the limit
        definition = definition[0:DEFINITION_MAX_LENGTH]
